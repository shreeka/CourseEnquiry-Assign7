 ...
 */
package com.leapfrog.classwork.controller;
...
public class ProgramController {
    ...
    private void course() throws FileNotFoundException, IOException
    {
        ...
        try ( 
            BufferedReader bufferedReader=new BufferedReader(new FileReader("C:\\Users\\User\\Desktop\\course.csv")))
                {
            String line="";
    ...
    private void enquiry() throws FileNotFoundException, IOException
    {
        ...
        try ( BufferedReader bufferedReader1 = new BufferedReader(new FileReader("C:\\Users\\User\\Desktop\\enquiry.csv"))) {
            BufferedWriter errorwriter =new BufferedWriter(new FileWriter("C:\\Users\\User\\Desktop\\error.csv"));
         BufferedWriter outputwriter =new BufferedWriter(new FileWriter("C:\\Users\\User\\Desktop\\output.csv"));
            String line1="";
